  ...
  <div @click.self="closeHandler" class="fixed top-0 left-0 w-full h-full bg-zinc-300/50 z-10">
    <aside
      ...
      <div v-if="totalSum>0"
        ...
        <h2 class="text-base sm:text-xl font-semibold mr-2">Total: <span class="ml-2 font-bold">${{ totalSum }}</span>
        </h2>
      </div>
    </aside>
  </div>
